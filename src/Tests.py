...
def test_make_index():
    ...
    check("text1.txt", {'желаю': [1, 2], 'крепкого': [1], 'здоровья': [1], 'улыбок': [1], 'преданных': [1],
                        'друзей': [1], 'финансов': [1], 'полные': [1], 'карманы': [1], 'добрых': [1], 'новостей': [1],
                        'пусть': [1], 'беда': [1], 'обходит': [1], 'дом': [2], 'твой': [2], 'стороной': [2],
                        'радость': [2], 'молодость': [2], 'веселье': [2], 'останутся': [2], 'тобой': [2],
                        'день': [2], 'тебе': [2], 'море': [2], 'счастья': [2], 'добра': [2], 'чтоб': [3],
                        'мечты': [3], 'сбывались': [3], 'днем': [3], 'рождения': [3]})
    check("text2.txt", {'advertisements': [1, 3], 'want': [1], 'to': [1, 2, 3], 'persuade': [1], 'us': [1], 'buy': [1],
                        'particular': [1], 'products': [1], 'how': [1], 'do': [1, 2], 'they': [1, 3], 'it': [1, 2],
                        'let’s': [1], 'imagine': [1], '…you’re': [1], 'watching': [1], 'tv': [1], 'it’s': [1],
                        'a': [1, 2, 3], 'hot': [1], 'evening': [1], 'you': [1, 2], 'feel': [1], 'thirsty': [1],
                        ...
                        'because': [1, 3], 'think': [1], 'could': [1], 'be': [1, 2, 3], 'useful': [1],
                        'satisfy': [1], 'your': [1], 'thirst': [1], 'advertisers': [1, 3], 'study': [1],
                        'learn': [1, 3], 'so': [1, 2, 3], 'that': [1, 3], 'can': [1, 2, 3], '‘teach’': [1], 'them': [1],
                        'respond': [1], 'their': [1], 'advertising': [1, 3], 'interested': [2], 'try': [2],
                        ...
                        'things': [2], 'example': [2, 3], 'in': [2, 3], 'winter': [2], 'weather': [2], 'cold': [2],
                        'family': [2], 'having': [2], 'warming': [2], 'cup': [2], 'tea': [2, 3], 'feeling': [2],
                        'cosy': [2], 'may': [2, 3], 'note': [2], '…': [2], 'here': [2], 'being': [2], 'as': [2],
                        'with': [2], 'he': [3], 'learned': [3], 'there': [3], 'need': [3], 'lots': [3], 'but': [3],
                        'have': [3], 'careful': [3], 'too': [3], 'much': [3], 'result': [3], 'consumer': [3],
                        'tiredness': [3], 'message': [3], 'fall': [3], 'on’deal': [3], 'ears’': [3], 'consumers': [3],
                        'generalize': [3], 'from': [3], 'what': [3], 'sometimes': [3], 'copy': [3], 'highly': [3],
                        'idea': [3], 'has': [3], 'been': [3], 'by': [3], '‘weston': [3], 'country’': [3], 'led': [3],
                        '‘daewoo': [3], 'automobile': [3], 'dealers': [3], '‘cadbury': [3], 'chocolate': [3],
                        'bars': [3]})
